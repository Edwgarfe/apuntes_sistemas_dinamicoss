...
$$ A = {s+2 \frac {2s-3}{(s+2)(s+10^{3})} (s = -2) \frac {2(-2)-3} {(-2)+10^{3})} = \frac {-4-3} {8^{3}}} = \frac {7}{512} $$
$$ B = {s+10^{3} \frac {2s-3}{(s+2)(s+10^{3})} (s = -10) \frac {2(-10)-3} {(-10)+2^{2})} = \frac {-20-3} {8}} = \frac {23}{8} $$
$$ C = (\frac {ds}{d}) \frac {2s-3} {s+2} (s = -10) (\frac {2(s+2)-1(2s-3)}{(s+2^{2})}) (s = -10) \frac {-16+23}{64} = \frac {7}{64}$$ 
$$ D = (\frac {(2-2)(s+2^{2})-2(s+2)(2(s+2)-2s-3)}{s+2^{4}}) (s = -10) \frac {-112}{4096}$$
